...
const Privacy = () => {
  return (
    <div className=' col-md-8 col-lg-7 col-xl-6 offset-md-2 offset-lg-2 offset-xl-3 space-3'>
    <h3> Privacy policy</h3>
   <br/>
    This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from agavente.com (the “Site”).<br/>
    <br/>
    ...
    <br/>
    Contact us<br/>
    For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e‑mail at hello@agavente.com.<br/>
    <br/>
    Agavente<br/>
